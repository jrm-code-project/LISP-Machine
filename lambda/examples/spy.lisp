;;; -*- Mode:LISP; Package:(SPY GLOBAL); Base:10; Fonts:(MEDFNB); Readtable:ZL -*-
...
Provided Functions:
 (SPY:PICK-A-PROCESS)
 (SPY:STACK-SPY <some-process, or window>)
 (SPY:QUANTUM <process> &optional <new-quantum> <scheduler-rate>)
 (SPY:BACKGROUND-SPY <process-or-window>)

Try this in your lisp listener (spy:background-spy)
...
(defun background-spy (&optional (x current-process))
  "Spy on stack group or process X. Prints a line of info
