...
;;;; Bogousity
;; How did all this crud ever make it into global??
;;  This is what the SYS package is for
 DTP-ARRAY-HEADER
 DTP-ARRAY-POINTER
 DTP-BODY-FORWARD
 DTP-CHARACTER
 ...
 DTP-FEF-POINTER
 DTP-FIX
 DTP-FREE                                       ;leave this in for now
 DTP-GC-FORWARD
 DTP-HEADER
 DTP-HEADER-FORWARD
 DTP-INSTANCE
...
;;;   and truly worthless symbols it's too late to flush from global now
 ...
 *CATCH
 *DEBUG-IO*                                     ;common
 ZL:*DEFAULT-PATHNAME-DEFAULTS*                 ;common -- incompatible
 *ERROR-OUTPUT*                                 ;common
 *EVALHOOK*                                     ;common
 *EXPR
 *FEATURES*                                     ;common
...
;ALLOW-VARIABLES-IN-FUNCTION-POSITION-SWITCH
 ...
 CHAR>                                          ;common
 CHARACTERP                                     ;common
 ZL:CHARACTER                                   ;common -- incompatible
 CHAR                                           ;common
 CHECK-ARG
 CHECK-ARG-TYPE
 CHECK-TYPE                                     ;common
 ...
 ZL:DEFSTRUCT                                   ;common -- incompatible
 DEFSUBST
 DEFSYSTEM
 DEFTYPE                                        ;common
 DEFUN-METHOD
...
;INSTANCE-VARIABLE-BOUNDP
 ...
 INTERN                                         ;common
 ZL:INTERSECTION                                ;common -- incompatible
 ISQRT                                          ;common
 KBD-CHAR-AVAILABLE
 KBD-TYI
 KBD-TYI-NO-HANG
...
;LISP-REINITIALIZE
 ...
 zl:MACROEXPAND-1                               ;incompatible
 MACROEXPAND-ALL
 zl:MACROEXPAND                                 ;incompatible
 MACROLET                                       ;common
 MAIL
 MAKE-AREA
 MAKE-ARRAY-INTO-NAMED-STRUCTURE
 ZL:MAKE-ARRAY                                  ;incompatible
...
;MULTIPLE-VALUE-RETURN
 ...
 NEQ
 NIL                                            ;common
 ZL:NINTERSECTION                               ;common -- incompatible
 NINTH                                          ;common
 NLEFT
 ZL:NLISTP
 NON-COMPLEX-NUMBER
...
;OBSOLETE-FUNCTION-WARNING-SWITCH
 ...
 READ-FOR-TOP-LEVEL
 ZL:READ-FROM-STRING                            ;common -- incompatible
 READ-LINE                                      ;common
 READ-METER
 READ-OR-END
 ...
 REMOVE-IF                                      ;common
 ZL:REMOVE                                      ;common -- incompatible
 REMPROP                                        ;common
 REMQ
 ZL:REM                                         ;common -- incompatible
 RENAME-FILE                                    ;common
