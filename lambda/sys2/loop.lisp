;;;   LOOP  -*- Mode:LISP; Package:System-Internals; Base:8; Lowercase:T; readtable: t -*-
;;;   **********************************************************************
...
#-Run-in-Maclisp
(defun loop-initialize-mapatoms-state (pkg localp) localp
...
(progn 'compile
 ...
 (defun loop-initialize-mapatoms-state (pkg localp)
    ...
    (prog ()
       (return
         (values (dont-optimize (pkg-number-of-slots pkg))
                 () pkg
