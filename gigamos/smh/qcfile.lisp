...
;;; $$$ Also DEFAFUNs come here. <21-Nov-88 smh>
           ...
           (IF (AND *MICROCOMPILE-SWITCH*
               ...
               (QC-TRANSLATE-FUNCTION
                 ...
                 (COND (QC-FILE-REL-FORMAT 'REL)
                       (T 'QFASL))))
           (RETURN NIL))
          ((eq (car form) 'DEFAFUN)                             ; $$$ added <21-Nov-88 smh>
           (format t "~%QC-FILE-FORM doing a DEFAFUN: ~s" (cadr form))
           )
...
;;;   DEFAFUN  - This hook added for cross-compiling assembly code $$$ <21-Nov-88 smh>
