...
;  (transporter-ram:load-transporter-ram (read-boot-vector *initial-transporter-ram-data-physical-location*))
  (transporter-ram:load-transporter-ram-data)
...
;  (modify-single-step-trap hw:$$trap-enable)
...
(defun cold-initialize-call-hardware ()
  ...
  (let ((free           #xfe)
    ...
    (hw:write-call-sp-hp #xF000)                ;Empty the heap and stack
    (hw:nop)
    (hw:nop)
    (hw:nop)
    (hw:nop)
