...
(defun manual-debug ()
  ...
  (selectq (tv:menu-choose ' (("SELECT ONE :"no-select nil)
           ...
           (7 (send terminal-io ':clear-screen)(setq test "write-map-loop (data)")(write-map-loop (data)))
           ...
           (22 (send terminal-io ':clear-screen)(setq test "rba-map-ram-test (&aux addr data temp)")
                                                            (rba-map-ram-test (&aux addr data temp)))
